...
function setup() {
    ...
    document.getElementById("confirmPasswort").addEventListener("change", validPassword);
...
function validPassword() {
    ...
    while (!passwort.match(allowedPassword)) {
        document.getElementById("noPassword").innerHTML = "Ungültiges Passwort";
    }
    if (passwort.match(allowedPassword)) {
        document.getElementById("noPassword").innerHTML = "Passwort ist gültig";
    }
}
...
function passwordValidation() {
    ...
    if (passValue !== confpassValue) {
        ...
        document.getElementById("notSamePassword").innerHTML = "Passwörter stimmen überein";
    }
}
